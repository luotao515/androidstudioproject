...
public class MyRatingBar extends LinearLayout {
    ...
    private Drawable mColor;  //被选中的星星的颜色
    ...
    public MyRatingBar(Context context, AttributeSet attrs) {
        ...
        mColor=ta.getDrawable(R.styleable.MyRatingBar_progressColor);
...
//                .getColor(R.color.star_color));
    ...
    private void init() {
        //填充布局
        View view = LayoutInflater.from(getContext()).inflate(R.layout.custom_rating_bar,
                this, false);
        this.addView(view);
        //查找子控件
...
//                    Log.d("click","点击在up里被视为滑动,maxDx"+maxDx);
//                }else{  //为点击事件
...
//        }
    ...
    public void setRating(float rating){
        ...
        for(int i=0;i<5;i++){
            ...
            if(mRating==0){
                layoutParams.width=0;
                Log.d("star","设置的mRating==0"+mRating);
            }else if(mRating<=1){
                if(i==0){
